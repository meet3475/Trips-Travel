  ...
  return (
    <>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <div className="my-8">
              ...
              <p className="bg-red-700 text-white font-bold rounded-2xl p-2 text-lg leading-8 hidden md:block">
      ...
      <section className="py-8 text-center px-6 md:px-12">
        ...
        <p className="text-lg leading-8 mb-8 font-bold text-black">
      ...
      <section className="bg-gray-800 min-h-screen py-8 px-6 md:px-12">
        <h1 className="text-[40px] md:text-[40px]  font-bold mb-4 text-center text-red-600">
          Featured Tours
        </h1>
      ...
      <section className=" md:max-h-[550px]">
        <div className="bg-red-700 text-white py-8 px-6 md:px-12">
          <div className="mx-auto text-center xl:w-[470px]">
            ...
            <p className="text-lg  font-bold leading-8 mb-8 text-gray-800">
